ALPLANDS:
[Alp]ine [La]kes ig[N]ition [D]ynamics [S]andbox
...
This example scenario has been tested with the following extensions installed : 
    ...
    <Extension Name="Magic Harvest" Version="2.0">
      <Type>disturbance:harvest</Type>
      <Assembly>Landis.Extension.MagicHarvest</Assembly>
      <Class>Landis.Extension.MagicHarvest.PlugIn</Class>
      <Description>Allows the update of the parameters of the harvest extension during the simulation</Description>
    </Extension>